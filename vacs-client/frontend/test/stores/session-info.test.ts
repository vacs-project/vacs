...
import type {ClientSessionInfo} from "../../src/types/client.ts";
...
const CLIENT: ClientSessionInfo["client"] = {
...
const PROFILE: Profile = {id: "profile0" as ProfileId, view: "page", tabbed: []};

const sessionInfo = (overrides: Partial<ClientSessionInfo> = {}): ClientSessionInfo => ({
    client: CLIENT,
        ...
        applySessionInfo(
            sessionInfo({
                profile: {
                    ...
                    activeProfile: {
                        type: "specific",
                        profile: {id: "profile9" as ProfileId, view: "page", tabbed: []},
                    },
                },
            }),
        );
